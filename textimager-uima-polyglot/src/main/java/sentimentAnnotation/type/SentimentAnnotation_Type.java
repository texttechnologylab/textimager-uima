...
public class SentimentAnnotation_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("sentimentAnnotation.type.SentimentAnnotation");
  ...
  public String getValue(int addr) {
      ...
      jcas.throwFeatMissing("value", "sentimentAnnotation.type.SentimentAnnotation");
