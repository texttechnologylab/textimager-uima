...
public class BigSenseTest {
	@Test
	public void bigSenseENTest() throws UIMAException{
		...
		//AnalysisEngineDescription fastSense = createEngineDescription(BigSense.class,
			//	BigSense.PARAM_DOCKER_IMAGE,"textimager-bigsense-en");

		AnalysisEngineDescription bigSense = createEngineDescription(BigSense.class,
				BigSense.PARAM_REST_ENDPOINT,"http://127.0.0.1:5000",
				BigSense.PARAM_DOCKER_VOLUMES,"/mnt/tb1/baumartz/git/fastSense/fastsense-en/best_model:/model");
		
		SimplePipeline.runPipeline(cas, bigSense);
