...
public class BigSense extends DockerRestAnnotator {
	private BigSenseEN bigSenseEN = null;
		
	@Override
	public void initialize(UimaContext aContext) throws ResourceInitializationException {
		super.initialize(aContext);
		
		bigSenseEN = new BigSenseEN();
		bigSenseEN.initialize(aContext);
	}
