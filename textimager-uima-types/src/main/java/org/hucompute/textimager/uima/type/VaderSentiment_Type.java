 ...
 * @generated */
public class VaderSentiment_Type extends Sentiment_Type {
  /** @generated */
  ...
  public double getPos(int addr) {
      ...
      jcas.throwFeatMissing("pos", "org.hucompute.textimager.uima.type.VaderSentiment");
  ...
  public double getNeu(int addr) {
      ...
      jcas.throwFeatMissing("neu", "org.hucompute.textimager.uima.type.VaderSentiment");
  ...
  public double getNeg(int addr) {
      ...
      jcas.throwFeatMissing("neg", "org.hucompute.textimager.uima.type.VaderSentiment");
