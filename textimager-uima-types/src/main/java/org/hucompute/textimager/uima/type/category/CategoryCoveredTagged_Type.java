...
public class CategoryCoveredTagged_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.hucompute.textimager.uima.type.category.CategoryCoveredTagged");
  ...
  public String getValue(int addr) {
      ...
      jcas.throwFeatMissing("value", "org.hucompute.textimager.uima.type.category.CategoryCoveredTagged");
  ...
  public double getScore(int addr) {
      ...
      jcas.throwFeatMissing("score", "org.hucompute.textimager.uima.type.category.CategoryCoveredTagged");
  ...
  public String getTags(int addr) {
      ...
      jcas.throwFeatMissing("tags", "org.hucompute.textimager.uima.type.category.CategoryCoveredTagged");
  ...
  public int getRef(int addr) {
      ...
      jcas.throwFeatMissing("ref", "org.hucompute.textimager.uima.type.category.CategoryCoveredTagged");
