 ...
 * @generated */
public class OCR extends Annotation {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(OCR.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected OCR() {/* intentionally empty block */}
   ...
   */
  public OCR(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public OCR(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
