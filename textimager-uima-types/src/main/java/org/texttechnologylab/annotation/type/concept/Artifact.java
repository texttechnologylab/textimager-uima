 ...
 * @generated */
public class Artifact extends AbstractNamedEntity {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(Artifact.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected Artifact() {/* intentionally empty block */}
   ...
   */
  public Artifact(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public Artifact(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
