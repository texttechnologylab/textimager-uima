 ...
 * @generated */
public class Shape extends AbstractNamedEntity {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(Shape.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected Shape() {/* intentionally empty block */}
   ...
   */
  public Shape(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public Shape(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
