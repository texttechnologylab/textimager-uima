 ...
 * @generated */
public class Act_Action_Activity extends AbstractNamedEntity {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(Act_Action_Activity.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected Act_Action_Activity() {/* intentionally empty block */}
   ...
   */
  public Act_Action_Activity(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
   ...
   */
  public Act_Action_Activity(JCas jcas) {
    super(jcas);
    readObject();   
  } 
  ...
  */  
  public Act_Action_Activity(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
