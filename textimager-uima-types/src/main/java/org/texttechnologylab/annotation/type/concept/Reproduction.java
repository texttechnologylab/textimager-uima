 ...
 * @generated */
public class Reproduction extends AbstractNamedEntity {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(Reproduction.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected Reproduction() {/* intentionally empty block */}
   ...
   */
  public Reproduction(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public Reproduction(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
