 ...
 * @generated */
public class Morphology extends AbstractNamedEntity {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(Morphology.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected Morphology() {/* intentionally empty block */}
   ...
   */
  public Morphology(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public Morphology(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
