 ...
 * @generated */
public class BioContext extends AbstractNamedEntity {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(BioContext.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected BioContext() {/* intentionally empty block */}
   ...
   */
  public BioContext(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public BioContext(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
