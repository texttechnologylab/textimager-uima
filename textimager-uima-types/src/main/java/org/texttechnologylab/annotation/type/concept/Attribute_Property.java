 ...
 * @generated */
public class Attribute_Property extends AbstractNamedEntity {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(Attribute_Property.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected Attribute_Property() {/* intentionally empty block */}
   ...
   */
  public Attribute_Property(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
   ...
   */
  public Attribute_Property(JCas jcas) {
    super(jcas);
    readObject();   
  } 
  ...
  */  
  public Attribute_Property(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
