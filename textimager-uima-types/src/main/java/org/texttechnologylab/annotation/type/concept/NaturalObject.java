 ...
 * @generated */
public class NaturalObject extends AbstractNamedEntity {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(NaturalObject.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected NaturalObject() {/* intentionally empty block */}
   ...
   */
  public NaturalObject(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
   ...
   */
  public NaturalObject(JCas jcas) {
    super(jcas);
    readObject();   
  } 
  ...
  */  
  public NaturalObject(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
