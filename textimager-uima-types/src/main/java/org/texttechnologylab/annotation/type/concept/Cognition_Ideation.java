 ...
 * @generated */
public class Cognition_Ideation extends AbstractNamedEntity {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(Cognition_Ideation.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected Cognition_Ideation() {/* intentionally empty block */}
   ...
   */
  public Cognition_Ideation(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
   ...
   */
  public Cognition_Ideation(JCas jcas) {
    super(jcas);
    readObject();   
  } 
  ...
  */  
  public Cognition_Ideation(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
