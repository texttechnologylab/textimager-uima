 ...
 * @generated */
public class Group_Collection extends AbstractNamedEntity {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(Group_Collection.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected Group_Collection() {/* intentionally empty block */}
   ...
   */
  public Group_Collection(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
   ...
   */
  public Group_Collection(JCas jcas) {
    super(jcas);
    readObject();   
  } 
  ...
  */  
  public Group_Collection(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
