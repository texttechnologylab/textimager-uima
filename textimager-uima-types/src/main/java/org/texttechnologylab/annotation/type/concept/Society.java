 ...
 * @generated */
public class Society extends AbstractNamedEntity {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(Society.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected Society() {/* intentionally empty block */}
   ...
   */
  public Society(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public Society(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
