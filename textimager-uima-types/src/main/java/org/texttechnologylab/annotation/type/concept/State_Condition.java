 ...
 * @generated */
public class State_Condition extends AbstractNamedEntity {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(State_Condition.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected State_Condition() {/* intentionally empty block */}
   ...
   */
  public State_Condition(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
   ...
   */
  public State_Condition(JCas jcas) {
    super(jcas);
    readObject();   
  } 
  ...
  */  
  public State_Condition(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
