 ...
 * @generated */
public class Chromista extends AbstractNamedEntity {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(Chromista.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected Chromista() {/* intentionally empty block */}
   ...
   */
  public Chromista(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public Chromista(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
