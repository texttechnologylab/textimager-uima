 ...
 * @generated */
public class Location_Place extends AbstractNamedEntity {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(Location_Place.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected Location_Place() {/* intentionally empty block */}
   ...
   */
  public Location_Place(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
   ...
   */
  public Location_Place(JCas jcas) {
    super(jcas);
    readObject();   
  } 
  ...
  */  
  public Location_Place(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
