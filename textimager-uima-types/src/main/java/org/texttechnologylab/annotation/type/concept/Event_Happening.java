 ...
 * @generated */
public class Event_Happening extends AbstractNamedEntity {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(Event_Happening.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected Event_Happening() {/* intentionally empty block */}
   ...
   */
  public Event_Happening(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
   ...
   */
  public Event_Happening(JCas jcas) {
    super(jcas);
    readObject();   
  } 
  ...
  */  
  public Event_Happening(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
