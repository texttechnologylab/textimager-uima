 ...
 * @generated */
public class Communication extends AbstractNamedEntity {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(Communication.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected Communication() {/* intentionally empty block */}
   ...
   */
  public Communication(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
   ...
   */
  public Communication(JCas jcas) {
    super(jcas);
    readObject();   
  } 
  ...
  */  
  public Communication(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
