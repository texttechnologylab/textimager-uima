 ...
 * @generated */
public class Protozoa extends AbstractNamedEntity {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(Protozoa.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected Protozoa() {/* intentionally empty block */}
   ...
   */
  public Protozoa(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public Protozoa(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
