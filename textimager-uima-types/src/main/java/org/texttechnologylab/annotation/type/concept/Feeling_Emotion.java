 ...
 * @generated */
public class Feeling_Emotion extends AbstractNamedEntity {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(Feeling_Emotion.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected Feeling_Emotion() {/* intentionally empty block */}
   ...
   */
  public Feeling_Emotion(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
   ...
   */
  public Feeling_Emotion(JCas jcas) {
    super(jcas);
    readObject();   
  } 
  ...
  */  
  public Feeling_Emotion(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
