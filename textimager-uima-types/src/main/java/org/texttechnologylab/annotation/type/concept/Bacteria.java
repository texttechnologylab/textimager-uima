 ...
 * @generated */
public class Bacteria extends AbstractNamedEntity {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(Bacteria.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected Bacteria() {/* intentionally empty block */}
   ...
   */
  public Bacteria(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public Bacteria(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
