 ...
 * @generated */
public class Process extends AbstractNamedEntity {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(Process.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected Process() {/* intentionally empty block */}
   ...
   */
  public Process(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public Process(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
