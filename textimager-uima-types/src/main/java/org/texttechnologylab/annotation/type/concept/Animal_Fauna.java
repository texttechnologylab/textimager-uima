 ...
 * @generated */
public class Animal_Fauna extends AbstractNamedEntity {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(Animal_Fauna.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected Animal_Fauna() {/* intentionally empty block */}
   ...
   */
  public Animal_Fauna(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public Animal_Fauna(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
