 ...
 * @generated */
public class Motive extends AbstractNamedEntity {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(Motive.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected Motive() {/* intentionally empty block */}
   ...
   */
  public Motive(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public Motive(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
