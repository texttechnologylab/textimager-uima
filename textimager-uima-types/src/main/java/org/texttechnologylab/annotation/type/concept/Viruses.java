 ...
 * @generated */
public class Viruses extends AbstractNamedEntity {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(Viruses.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected Viruses() {/* intentionally empty block */}
   ...
   */
  public Viruses(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public Viruses(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
