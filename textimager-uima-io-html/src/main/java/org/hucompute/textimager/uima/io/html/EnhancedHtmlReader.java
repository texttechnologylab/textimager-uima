        ...
        throws IOException, CollectionException
    {
                ...
                if (node instanceof TextNode) {
                    ...
                    if (type != null) {
                    	if (type == MetaDataStringField.type) {
                    		...
                    		// Save meta data and add later when we have document length for begin/end
        ...
        for (HashMap.Entry<String, ArrayList<String>> entry : metaData.entrySet()) {
        	for (String value : entry.getValue()) {
	    		MetaDataStringField meta = new MetaDataStringField(aJCas, 0, aJCas.getDocumentText().length());
